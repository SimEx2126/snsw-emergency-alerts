...
export class TelegramAlerter {
   ...
   * Delegates to the shared hazard tiering rules so every transport
   * (email, Telegram, Discord) classifies signals identically.
   */
  _ruleBasedEvaluation(signals, delta) {
    return evaluateHazardSignals(signals, delta);
  }
